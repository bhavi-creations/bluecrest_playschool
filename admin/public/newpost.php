                    ...
                    <div class="row">
                        <div class="col-xl-11">
                            <div class="card shadow mb-4">
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
                                    <form style='color:black;' id="uploadimageform" action="upload_image.php" method="POST" enctype="multipart/form-data">
                                        <div class="mb-3">
                                            <label for="imageTitle" class="form-label text-primary">ENTER TITLE</label>
                                            <input type="text" class="form-control text-grey-900" name='title' id="imageTitle" placeholder="TITLE" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="formFileImage" class="form-label text-primary">Choose Image</label>
                                            <input class="form-control" name="image" type="file" id="formFileImage" accept="image/*" required>
                                        </div>
                                        <div class='row p-3'>
