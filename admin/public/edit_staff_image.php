...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $image_path = $staff['image']; // default to old image
    ...
    $stmt->bind_param('ssssi', $name, $role, $staff_type, $image_path, $id);

    if ($stmt->execute()) {
        echo "<script>
            alert('✅ Staff record updated successfully.');
            window.location.href = 'staff_allimage.php';
        </script>";
        exit;
    } else {
        echo "❌ Failed to update staff record: " . $conn->error;
    }
}
?>
...
<head>
    <meta charset="UTF-8" />
    <title>Edit Staff - Blue Crest Dashboard</title>
                                ...
                                <div class="card-body">
                                    <form method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img src="<?= htmlspecialchars($staff['image']); ?>" alt="Current Image" style="max-width: 200px; max-height: 150px; border: 1px solid #ccc; padding: 5px;"><br><br>
                                        </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span style="color:black;">©2025 Blue Crest. All Rights Reserved. Designed & Developed by 
