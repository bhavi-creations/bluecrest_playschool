   ...
   <div class="container">
      <div class="row space">
         <div class="container-fluid py-5">
            <!-- <h2 class="text-center"> ABACUS</h2> -->
...
<section class="mb-5">
   <div class="container">
      <div class="row">
         <div class="container-fluid py-5">
            <!-- <h2 class="text-center">Dance And Music</h2> -->
         ...
         <div class="col-md-8">
            <p>
               ...
               Story-based Learning Using storytelling and play to teach abacus techniques.
...
<section class="mb-5">
   <div class="container">
      <div class="row">
         <div class="container-fluid py-5">
            <!-- <h2 class="text-center">Field Trips</h2> -->
