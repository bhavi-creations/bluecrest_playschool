...
<!-- Hero Section Start -->
<section class="banner-section banner-1 overflow-hidden banner_bg">
    <div class="container">
    ...
    <!-- Element -->
    <img src="assets/img/abanner/left-ring.png" alt="img" class="left-ring">
    <img src="assets/img/abanner/right-ring.png" alt="img" class="right-ring">
    <img src="assets/img/abanner/upen-element.png" alt="img" class="global-upen">
    <!-- Element -->
</section>
...
<div class="team pb-5">
    <div class="container pb-5">
        ...
        // Fetch only directors from the database
        $sql = "SELECT name, role, image FROM staff_image_uploads WHERE staff_type = 'Director' ORDER BY id DESC";
            ...
            <?php if ($result->num_rows > 0): ?>
                <div class="row">
                    ...
                    while ($row = $result->fetch_assoc()):
                        ...
                        // Construct image path for browser
                        $imagePath = "admin/public/uploads/staff/" . htmlspecialchars($row['image']);

                        // Fallback image if the DB image is empty
                        if (empty($row['image'])) {
